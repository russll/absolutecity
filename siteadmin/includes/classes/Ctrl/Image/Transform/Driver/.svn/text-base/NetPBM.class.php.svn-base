...
class Ctrl_Image_Transform_Driver_NetPBM extends Ctrl_Image_Transform
{
     ...
     * @return none
     */
    public function save($filename, $type=null, $quality = 85)
    {
     ...
     * @return none
     */
    public function display($type = null, $quality = 75)
    {
