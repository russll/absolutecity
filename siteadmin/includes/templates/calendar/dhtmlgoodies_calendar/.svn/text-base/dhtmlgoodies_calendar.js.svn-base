...
var pathToImages = '/includes/templates/calendar/images/';	// Relative to your HTML file
...
switch(languageCode){
	...
	case "pt-br":  /* Brazilian portuguese (pt-br) */
		...
		break;
	case "fr":      /* French */
		var monthArray = ['Janvier','Fйvrier','Mars','Avril','Mai','Juin','Juillet','Aoыt','Septembre','Octobre','Novembre','Dйcembre'];		
	...
	case "da": /*Danish*/
		...
		var dayArray = ['man','tirs','ons','tors','fre','lшr','sшn']
		var weekString = 'Uge';
		var todayString = 'I dag er den';
		break;	
	case "hu":	/* Hungarian  - Remember to use UTF-8 encoding, i.e. the <meta> tag */
		var monthArray = ['JanuГЎr','FebruГЎr','MГЎrcius','Г?prilis','MГЎjus','JГєnius','JГєlius','Augusztus','Szeptember','OktГіber','November','December'];
		var monthArrayShort = ['Jan','Feb','MГЎrc','Г?pr','MГЎj','JГєn','JГєl','Aug','Szep','Okt','Nov','Dec'];
