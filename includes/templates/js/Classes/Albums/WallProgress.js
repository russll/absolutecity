...
function FileProgress(file, targetID) { 
	...
	var AlbID = $('#id_upl_photo_album').val();
	
	this.filePrID = ''+file.id;
	//this.filePrName = ''+UserID+'_mw_'+AlbID+'_'+cD+cM+cY+cHour+cMin+'_'+crand+'_'+file.name; //+rand(1, 10000)
	this.filePrName = ''+UserID+'_alb_'+AlbID+'_'+crand+'_'+file.name; //+rand(1, 10000)
	this.opacity = 100;
	this.height = 0;
