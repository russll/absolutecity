...
function FileProgress(file, targetID) { 
	...
	//this.filePrName = ''+UserID+'_ww_'+WardID+'_'+cD+cM+cY+cHour+cMin+'_'+crand+'_'+file.name; //+rand(1, 10000)
	this.filePrName = ''+UserID+'_j_'+UserOtherID+'_'+crand+'_'+Txt2Charse(file.name); //+rand(1, 10000)
	this.opacity = 100;
	this.height = 0;
