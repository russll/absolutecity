<?php /* Smarty version 2.6.11, created on 2014-04-23 21:04:55
         compiled from mods/mission/_wall.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'mods/mission/_wall.html', 29, false),array('modifier', 'nl2br', 'mods/mission/_wall.html', 37, false),array('modifier', 'dlong', 'mods/mission/_wall.html', 80, false),array('function', 'html_tmpl_time', 'mods/mission/_wall.html', 33, false),)), $this); ?>
<h2>Mission entries</h2>
<input id="mission_id" name="mission_id" type="hidden" value="<?php echo $this->_tpl_vars['mission_id']; ?>
" />
<div id="id_mes_list" style="word-wrap: break-word; overflow: hidden; max-width:  500px; width: 500px; display: block;">
<?php if ($this->_tpl_vars['mai']):  $_from = $this->_tpl_vars['mai']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
')">Unfriend</a><?php endif; ?></p>
												<p><a href="javascript:void(0);" onclick="oUsers.ReportUser($(this), '<?php echo $this->_tpl_vars['i']['uid']; ?>
');" class="user_report">Report this user</a></p>
					</div>
					</div>
				</div>
				<?php endif; ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "mods/mission/_wall_actions.html", 'smarty_include_vars' => array()));
...
mission/wall/<?php echo $this->_tpl_vars['i']['p_path']; ?>
...
"/>
                                ...
                                <td>
                                    <span class="story_badge" ><?php if ($this->_tpl_vars['i']['story']):  echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['i']['story'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)))) ? $this->_run_mod_handler('dlong', true, $_tmp, 39) : smarty_modifier_dlong($_tmp, 39));  endif; ?></span>
                                </td>
                            </table>
                    <br/>
                <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
						...
						<?php if ($this->_tpl_vars['i']['ltype']): ?><p style="color: #5fb0fc">[<?php echo $this->_tpl_vars['ar_nloc_places'][$this->_tpl_vars['i']['ltype']]; ?>
]</p><?php endif; ?>
						<p><?php echo smarty_function_html_tmpl_time(array('val' => $this->_tpl_vars['i']['pdate'],'type' => 1), $this);?>
 </p>
                    <?php endif; ?>
...
$this->_sections['si']['loop'] = is_array($_loop=$this->_tpl_vars['answ']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
" class="tools-link"><a href="javascript: void(0);" onclick="oMWall.GetAnswList( '<?php echo $this->_tpl_vars['mission_id']; ?>
...
" name="WI[story]" class="expand40-500 cl_answ_story" maxlength="480"></textarea>

                                                <div class="add_smile_tab"><a class="nav_attach_smile" onclick="oMWall.AddSmileTab('<?php echo $this->_tpl_vars['i']['id']; ?>
');" mtype="smile" style="cursor: pointer;"><img src="<?php echo $this->_tpl_vars['imgDir']; ?>
smile_main.gif" alt="" /></a></div>
                                                <div class="share-white-b" style="margin-bottom: 3px; margin-top: 2px;"><a href="javascript: void(0);" onclick="oMWall.AddMesAnsw( '<?php echo $this->_tpl_vars['i']['id']; ?>
' );"><img src="<?php echo $this->_tpl_vars['imgDir']; ?>
...
<div class="box001" id="id_div_empty_mes">
	<div class="post-box">
...
<?php if (! $this->_tpl_vars['show_item']): ?>
    ...
    <div id="id_div_show_more_mes" class="more-box" align="center" style="margin-left: 0px; padding-left: 0px;">
	    <a href="javascript: void(0);" onclick="oMWall.GetList( '<?php echo $this->_tpl_vars['mission_id']; ?>
', $('.box001:last').attr('mid'), '<?php echo $this->_tpl_vars['sf_type']; ?>
', '<?php echo $this->_tpl_vars['sf']; ?>
', 1 );">More <img src="/i/arr01.gif"  /></a>
    </div>
    <?php endif;  else: ?>
    <div id="id_div_show_more_mes" class="more-box" align="center" style="margin-left: 0px; padding-left: 0px;">
	    <a href="javascript: void(0);" onclick="$('#id_mes_list').html(''); oMWall.GetList( '<?php echo $this->_tpl_vars['mission_id']; ?>
', '0', '<?php echo $this->_tpl_vars['sf_type']; ?>
', '<?php echo $this->_tpl_vars['sf']; ?>
', 1 );">Show all <img src="/i/arr01.gif"  /></a>
    </div>
<?php endif; ?>
