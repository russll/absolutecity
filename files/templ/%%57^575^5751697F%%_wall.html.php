<?php /* Smarty version 2.6.11, created on 2014-03-15 09:09:42
         compiled from mods/journal/_wall.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'mods/journal/_wall.html', 47, false),array('modifier', 'html_substr', 'mods/journal/_wall.html', 54, false),array('modifier', 'closetags', 'mods/journal/_wall.html', 54, false),array('modifier', 'count_characters', 'mods/journal/_wall.html', 57, false),array('modifier', 'nl2br', 'mods/journal/_wall.html', 202, false),array('function', 'html_tmpl_time', 'mods/journal/_wall.html', 68, false),)), $this); ?>
<h2>Journal entries</h2>
<div id="id_mes_list">
    <?php if ($this->_tpl_vars['mai']): ?>
...
ico<?php if (5 == $this->_tpl_vars['i']['ptype']): ?>07_<?php elseif (4 == $this->_tpl_vars['i']['ptype']): ?>06<?php elseif (3 == $this->_tpl_vars['i']['ptype']): ?>05_<?php elseif (2 == $this->_tpl_vars['i']['ptype']): ?>04_<?php elseif (1 == $this->_tpl_vars['i']['ptype']): ?>03<?php endif; ?>.png" />
                </em>
		        <?php endif; ?>

                <div class="b-awatar">
                    <a href="javascript: void(0);" onclick="$('#id_dropbox_<?php echo $this->_tpl_vars['i']['id']; ?>
').slideToggle('slow');">
...
no_photo_m66.jpg<?php endif; ?>"  <?php if ($this->_tpl_vars['i']['uid'] == $this->_tpl_vars['UserInfo']['uid']): ?>class="small_avatar"<?php endif; ?>/>
                    </a>
...
no_photo_m56.jpg<?php endif; ?>"  style="width: 56px; height: 56px;" <?php if ($this->_tpl_vars['i']['uid'] == $this->_tpl_vars['UserInfo']['uid']): ?>class="small_avatar"<?php endif; ?>/></a>
                    <div>
...
" class="expand40-500 cl_answ_story" name="WI[story]" style="width: 85%;" maxlength="480"></textarea>
...
', $('.box001:last').attr('mid') );">More <img src="/i/arr01.gif" alt=""  /></a>
    ...
    <?php else: ?>
        <div id="id_div_show_more_mes" class="more-box" align="center" style="margin-left: 0px; padding-left: 0px;">
            <a href="javascript: void(0);" onclick="$('#id_mes_list').html(''); oJournal.GetList( '<?php echo $this->_tpl_vars['ui']['uid']; ?>
', '0' );">Show all <img src="/i/arr01.gif" alt=""  /></a>
        </div>
    <?php endif; ?>
</div>