<?php /* Smarty version 2.6.11, created on 2014-05-05 06:38:07
         compiled from mods/friends/_subscr_list.html */ ?>
			<?php if ($this->_tpl_vars['ar_subscr']): ?>
				<div id="id_subscr_list" class="cl_subscr_list">
				<h2>Followers's List</h2>
				<div id="id_subscr_mlist">
...
');">Report this user</a></p>
			...
			<?php if ($this->_tpl_vars['ar_subscribition']): ?>
				<div id="id_subscribition_list" class="cl_subscr_list">
				<h2>People I follow List</h2>
...
');">Report this user</a></p>
			...
			<?php if (! $this->_tpl_vars['ar_subscr'] && ! $this->_tpl_vars['ar_subscribition']): ?>
				<h2>Followers and Subscriptions' List</h2>
				<div class="box001">
					<div class="post-box">
