<?php /* Smarty version 2.6.11, created on 2014-04-23 21:00:52
         compiled from mods/albums/_photo.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_tmpl_time', 'mods/albums/_photo.html', 38, false),array('modifier', 'date_format', 'mods/albums/_photo.html', 38, false),)), $this); ?>
<h2>From <a href="<?php echo $this->_tpl_vars['siteAdr']; ?>
id<?php echo $this->_tpl_vars['ui']['uid']; ?>
/albums/id<?php echo $this->_tpl_vars['ai']['aid']; ?>
"><?php echo $this->_tpl_vars['ai']['name']; ?>
</a></h2>
...
no_photo_m56.jpg<?php endif; ?>"  style="width: 56px; height: 56px;" /></a>
                <div>
                    <p><b><?php echo $this->_tpl_vars['i']['first_name']; ?>
 <?php echo $this->_tpl_vars['i']['last_name']; ?>
</b> wrote:</p>
                    <p><?php echo $this->_tpl_vars['i']['text']; ?>
</p>
                    <p style="font-size:10px;padding-top:5px;"><?php echo smarty_function_html_tmpl_time(array('val' => $this->_tpl_vars['i']['dt'],'type' => 1), $this);?>
 (<?php echo ((is_array($_tmp=$this->_tpl_vars['i']['dt'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%b %d, %Y") : smarty_modifier_date_format($_tmp, "%b %d, %Y")); ?>
)</p>
                </div>
            </li>
