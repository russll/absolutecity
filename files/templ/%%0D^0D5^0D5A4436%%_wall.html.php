<?php /* Smarty version 2.6.11, created on 2014-03-15 08:51:13
         compiled from mods/profile/_wall.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'mods/profile/_wall.html', 56, false),array('modifier', 'nl2br', 'mods/profile/_wall.html', 63, false),array('modifier', 'dlong', 'mods/profile/_wall.html', 166, false),array('function', 'html_tmpl_time', 'mods/profile/_wall.html', 68, false),)), $this); ?>
<!--[if IE]>
...
?>
    <div id="id_wall_mes_<?php echo $this->_tpl_vars['i']['com_parent']; ?>
" mid="<?php echo $this->_tpl_vars['i']['com_parent']; ?>
" class="box001 cl_wall_mes"
         onmouseover="$('#tl_<?php echo $this->_tpl_vars['i']['com_parent']; ?>
').show();" onmouseout="$('#tl_<?php echo $this->_tpl_vars['i']['com_parent']; ?>
').hide();">
        <div class="post-box">
            <div class="post-box-bg<?php if (5 == $this->_tpl_vars['i']['ptype']): ?>04<?php elseif (4 == $this->_tpl_vars['i']['ptype']): ?>05<?php elseif (3 == $this->_tpl_vars['i']['ptype']): ?>02<?php elseif (2 == $this->_tpl_vars['i']['ptype']): ?>03<?php elseif (1 == $this->_tpl_vars['i']['ptype']): ?>01<?php else: ?>00<?php endif; ?>" id="post_box_bg_<?php echo $this->_tpl_vars['i']['com_parent']; ?>
" style="min-height: 68px">

                <?php if (! empty ( $this->_tpl_vars['i']['ptype'] )): ?>
                <em>
                    <img src="<?php echo $this->_tpl_vars['imgDir']; ?>
ico<?php if (5 == $this->_tpl_vars['i']['ptype']): ?>07_<?php elseif (4 == $this->_tpl_vars['i']['ptype']): ?>06<?php elseif (3 == $this->_tpl_vars['i']['ptype']): ?>05_<?php elseif (2 == $this->_tpl_vars['i']['ptype']): ?>04_<?php elseif (1 == $this->_tpl_vars['i']['ptype']): ?>03<?php endif; ?>.png" alt=""/>
                </em>
                <?php endif; ?>

                <div class="b-awatar">
                    <a href="javascript: void(0);" onclick="$('#id_dropbox_<?php echo $this->_tpl_vars['i']['com_parent']; ?>
...
no_photo_m66.jpg<?php endif; ?>" alt=""/></a>
...
', 0)">Add as
                                    Friend</a><?php else: ?><a href="javascript: void(0);" onclick="oFriends.SHConfirmPopup(1, 'id_confirm_friends_popup', '<?php echo $this->_tpl_vars['i']['uid']; ?>
')">Unfriend</a><?php endif; ?>
                                </p>
...
">
 ...
 <?php echo $this->_tpl_vars['i']['last_name']; ?>
                    ...
                    <?php if ($this->_tpl_vars['i']['ev_title']): ?> is going to <?php echo $this->_tpl_vars['i']['ev_title'];  endif; ?>
                </div>
...
id<?php echo $this->_tpl_vars['i']['uid']; ?>
/albums/id<?php echo $this->_tpl_vars['i']['p_img_aid']; ?>
/id<?php echo $this->_tpl_vars['i']['p_img_1_id'];  else: ?>javascript: void(0); <?php endif; ?> "<?php if (! $this->_tpl_vars['i']['p_img_1_id']): ?> style="cursor: default;" <?php endif; ?>><img src="<?php echo $this->_tpl_vars['fImgDir'];  if (! $this->_tpl_vars['i']['is_copy_type']): ?>wall/<?php else: ?>mission/wall/<?php endif;  echo $this->_tpl_vars['i']['p_path']; ?>
/<?php echo $this->_tpl_vars['i']['p_img_1']; ?>
" style="max-width: 300px; max-height: 200px;"/></a></em><?php endif; ?>
                        <?php if ($this->_tpl_vars['i']['p_img_2']): ?><em><a href="<?php if ($this->_tpl_vars['i']['p_img_aid'] && $this->_tpl_vars['i']['p_img_2_id']): ?> <?php echo $this->_tpl_vars['siteAdr']; ?>
id<?php echo $this->_tpl_vars['i']['uid']; ?>
/albums/id<?php echo $this->_tpl_vars['i']['p_img_aid']; ?>
/id<?php echo $this->_tpl_vars['i']['p_img_2_id']; ?>
 <?php else: ?> javascript: void(0); <?php endif; ?> "<?php if (! $this->_tpl_vars['i']['p_img_2_id']): ?> style="cursor: default;"<?php endif; ?>><img src="<?php echo $this->_tpl_vars['fImgDir'];  if (! $this->_tpl_vars['i']['is_copy_type']): ?>wall/<?php else: ?>mission/wall/<?php endif;  echo $this->_tpl_vars['i']['p_path']; ?>
/<?php echo $this->_tpl_vars['i']['p_img_2']; ?>
" style="max-width: 300px; max-height: 200px;"/></a></em><?php endif; ?>
                        <?php if ($this->_tpl_vars['i']['p_img_3']): ?><em><a href=" <?php if ($this->_tpl_vars['i']['p_img_aid'] && $this->_tpl_vars['i']['p_img_3_id']): ?> <?php echo $this->_tpl_vars['siteAdr']; ?>
id<?php echo $this->_tpl_vars['i']['uid']; ?>
/albums/id<?php echo $this->_tpl_vars['i']['p_img_aid']; ?>
/id<?php echo $this->_tpl_vars['i']['p_img_3_id']; ?>
 <?php else: ?> javascript: void(0); <?php endif; ?> "<?php if (! $this->_tpl_vars['i']['p_img_3_id']): ?> style="cursor: default;"<?php endif; ?>><img src="<?php echo $this->_tpl_vars['fImgDir'];  if (! $this->_tpl_vars['i']['is_copy_type']): ?>wall/<?php else: ?>mission/wall/<?php endif;  echo $this->_tpl_vars['i']['p_path']; ?>
...
id<?php echo $this->_tpl_vars['i']['uid3']; ?>
"><?php echo $this->_tpl_vars['i']['first_name3'];  echo $this->_tpl_vars['i']['last_name3']; ?>
</a> <?php else: ?> ... <?php endif; ?>
                    <?php elseif (3 == $this->_tpl_vars['i']['ptype']): ?>
                        For family
                    <?php elseif (2 == $this->_tpl_vars['i']['ptype']): ?>
                        For friends <?php if ($this->_tpl_vars['i']['pstype']): ?> ( <?php if ($this->_tpl_vars['i']['pstype'] == 5): ?> <?php if ($this->_tpl_vars['uclasses_index'][$this->_tpl_vars['i']['pclass']]): ?>
                        <?php echo $this->_tpl_vars['uclasses_index'][$this->_tpl_vars['i']['pclass']]; ?>
 <?php else: ?> Classmates <?php endif; ?> <?php elseif ($this->_tpl_vars['i']['pstype'] == 1): ?> Aaronic priesthood
                        <?php elseif ($this->_tpl_vars['i']['pstype'] == 2): ?> Young man <?php elseif ($this->_tpl_vars['i']['pstype'] == 3): ?> Priesthood holders <?php elseif ($this->_tpl_vars['i']['pstype'] == 4): ?>
                         Melchizedek priesthood <?php elseif ($this->_tpl_vars['i']['pstype'] == 7): ?> high priest <?php elseif ($this->_tpl_vars['i']['pstype'] == 12): ?> Young woman
                        <?php elseif ($this->_tpl_vars['i']['pstype'] == 100): ?> <?php if ($this->_tpl_vars['UserInfo']['ward_id'] == $this->_tpl_vars['i']['uvid']): ?> <a href="<?php echo $this->_tpl_vars['siteAdr']; ?>
wards/id<?php echo $this->_tpl_vars['UserInfo']['ward_id']; ?>
"><?php echo $this->_tpl_vars['UserInfo']['ward']; ?>
</a>
                        <?php else: ?> prev ward <?php endif; ?> <?php elseif ($this->_tpl_vars['i']['pstype'] == 101): ?> <?php if ($this->_tpl_vars['UserInfo']['stake_id'] == $this->_tpl_vars['i']['uvid']): ?> <a href="<?php echo $this->_tpl_vars['siteAdr']; ?>
wards/id<?php echo $this->_tpl_vars['UserInfo']['stake_id']; ?>
"><?php echo $this->_tpl_vars['UserInfo']['stake']; ?>
</a> <?php else: ?> prev stake <?php endif; ?>
                        <?php endif; ?> )
                        <?php endif; ?>
                    <?php elseif (1 == $this->_tpl_vars['i']['ptype']): ?>
                        For friends and followers <?php if ($this->_tpl_vars['i']['pstype']): ?> ( <?php if ($this->_tpl_vars['i']['pstype'] == 5): ?> <?php if ($this->_tpl_vars['uclasses_index'][$this->_tpl_vars['i']['pclass']]): ?>
                        <?php echo $this->_tpl_vars['uclasses_index'][$this->_tpl_vars['i']['pclass']]; ?>
 <?php else: ?> Classmates <?php endif; ?> <?php elseif ($this->_tpl_vars['i']['pstype'] == 1): ?> Aaronic priesthood
                        <?php elseif ($this->_tpl_vars['i']['pstype'] == 2): ?> Young man <?php elseif ($this->_tpl_vars['i']['pstype'] == 3): ?> Priesthood holders <?php elseif ($this->_tpl_vars['i']['pstype'] == 4): ?>
                        Melchizedek priesthood <?php elseif ($this->_tpl_vars['i']['pstype'] == 7): ?> high priest <?php elseif ($this->_tpl_vars['i']['pstype'] == 12): ?> Young woman
...
?>
                           <?php if ($this->_tpl_vars['ssi'][$this->_sections['ssindex']['index']]['first_name']): ?>
                           <li>
                             <img src="<?php if ($this->_tpl_vars['ssindex']['image']):  echo $this->_tpl_vars['fImgDir']; ?>
...
"><?php if ($this->_tpl_vars['answ'][$this->_sections['si']['index']]['first_name'] || $this->_tpl_vars['answ'][$this->_sections['si']['index']]['last_name']):  echo $this->_tpl_vars['answ'][$this->_sections['si']['index']]['first_name']; ?>
            ...
            <?php if (2 < $this->_tpl_vars['i']['cnt_answ']): ?>
               <div id="id_div_show_more_answ_<?php echo $this->_tpl_vars['i']['com_parent']; ?>
...
/s/s_<?php echo $this->_tpl_vars['UserInfo']['image'];  else:  echo $this->_tpl_vars['imgDir']; ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php if (! $this->_tpl_vars['show_item']): ?>
    <?php if (( $this->_tpl_vars['pcnt']+$this->_tpl_vars['rcnt'] ) < $this->_tpl_vars['cnt_mes']): ?>
...
', '', '1' );">More <img src="/i/arr01.gif" alt="" /></a>
    ...
    <?php else: ?>
    <div id="id_div_show_more_mes" class="more-box" align="center" style="margin-left: 0px; padding-left: 0px;">
        <a href="javascript: void(0);" onclick="$('#id_mes_list').html('');oWall.GetList( '<?php echo $this->_tpl_vars['ui']['uid']; ?>
', '0', '<?php echo $this->_tpl_vars['sf_type']; ?>
', '<?php echo $this->_tpl_vars['sf']; ?>
', '', '1' );">Show all <img src="/i/arr01.gif" alt="" /></a>
    </div>
    <?php endif; ?>
