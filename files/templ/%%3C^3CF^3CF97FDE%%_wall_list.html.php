<?php /* Smarty version 2.6.11, created on 2014-10-07 05:09:19
         compiled from mods/inbox/_wall_list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'mods/inbox/_wall_list.html', 14, false),array('modifier', 'dlong', 'mods/inbox/_wall_list.html', 66, false),array('function', 'html_str_format', 'mods/inbox/_wall_list.html', 43, false),array('function', 'html_tmpl_time', 'mods/inbox/_wall_list.html', 56, false),)), $this); ?>
<?php if ($this->_tpl_vars['fr_info']): ?>
<h2 id="id_fr_name">
    <font class="inbox_text">
    <?php if ($this->_tpl_vars['fr_info']):  echo $this->_tpl_vars['fr_info']['first_name']; ?>
 <?php echo $this->_tpl_vars['fr_info']['last_name']; ?>
 <?php else: ?> Select a friend <?php endif; ?>
    </font>

    <span class="block_a" style="margin-top:0px; padding-top: 0px; float:right;">
...
<?php $this->assign('fname', ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fr_info']['first_name'])) ? $this->_run_mod_handler('cat', true, $_tmp, ' ') : smarty_modifier_cat($_tmp, ' ')))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['fr_info']['last_name']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['fr_info']['last_name'])));  $this->assign('fname', $this->_tpl_vars['fname']); ?>
...
');">More <img src="/i/arr01.gif" alt=""  /></a-->
     <a href="javascript: void(0);" onclick="oIWall.GetListMore('<?php echo $this->_tpl_vars['fr_info']['uid']; ?>
');" style="float:left;">View older messages<!--img src="/i/arr01.gif" alt=""  /--></a>
</div>
<div id="id_mes_list" class="more_mes_list" <?php if ($this->_tpl_vars['mai'] && ! $this->_tpl_vars['fshow']): ?> style="overflow-y:scroll;width:100%;max-height:800px; margin-bottom:10px; margin-top:10px;"<?php endif; ?> style="position:relative;">
