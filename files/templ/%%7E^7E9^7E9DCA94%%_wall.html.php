<?php /* Smarty version 2.6.11, created on 2014-08-22 15:54:29
         compiled from mods/wards/_wall.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'mods/wards/_wall.html', 37, false),array('modifier', 'nl2br', 'mods/wards/_wall.html', 38, false),array('modifier', 'dlong', 'mods/wards/_wall.html', 107, false),array('function', 'html_tmpl_time', 'mods/wards/_wall.html', 44, false),)), $this); ?>
<?php if ($this->_tpl_vars['wid'] == 0): ?>
<h2>We're sorry, this member hasn't yet selected their ward</h2>
<?php else: ?>
<h2>Ward entries</h2>
<input id="wid" name="wid" type="hidden" value="<?php echo $this->_tpl_vars['wid']; ?>
" />
...
" ><b><?php echo $this->_tpl_vars['i']['ward_from']; ?>
					...
					is going to <?php if ($this->_tpl_vars['i']['ev_title']):  echo $this->_tpl_vars['i']['ev_title'];  endif; ?></div>
				<div class="event-txt">
...
no_photo_m56.jpg<?php endif; ?>" alt="" <?php if ($this->_tpl_vars['i']['uid'] == $this->_tpl_vars['UserInfo']['uid']): ?>class="small_avatar"<?php endif; ?> style="width: 56px; height: 56px;" /></a>
					<div>
...
', 1 );">More <img src="/i/arr01.gif" alt="" /></a>
    ...
    <?php else: ?>
        <div id="id_div_show_more_mes" class="more-box" align="center" style="margin-left: 0px; padding-left: 0px;">
		    <a href="javascript: void(0);" onclick="$('#id_mes_list').html(''); oWWall.GetList( '<?php echo $this->_tpl_vars['wid']; ?>
